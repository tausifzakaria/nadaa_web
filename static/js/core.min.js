...
!(function (A, e, t) {
  ...
  function s(A, e) {
    if ("object" == typeof A) for (var t in A) y(A, t) && s(t, A[t]);
    else {
      A = A.toLowerCase();
      var i = A.split("."),
        n = Modernizr[i[0]];
      if ((2 == i.length && (n = n[i[1]]), "undefined" != typeof n))
        return Modernizr;
  ...
  function l(A, t, i, n) {
    ...
    if (parseInt(i, 10))
      for (; i--; )
        (w = r("div")), (w.id = n ? n[i] : l + (i + 1)), D.appendChild(w);
    return (
      (a = r("style")),
      (a.type = "text/css"),
      (a.id = "s" + l),
      ...
      P.appendChild(D),
      a.styleSheet
        ? (a.styleSheet.cssText = A)
        : a.appendChild(e.createTextNode(A)),
      (D.id = l),
      P.fake &&
        ((P.style.background = ""),
      ...
      (o = t(D, A)),
      P.fake
        ? (P.parentNode.removeChild(P), (g.style.overflow = s), g.offsetHeight)
        : D.parentNode.removeChild(D),
      !!o
    );
  }
  ...
  (Modernizr.prototype = P),
    ...
    Modernizr.addTest(
      "ie8compat",
      !A.addEventListener && !!e.documentMode && 7 === e.documentMode
    ),
    Modernizr.addTest(
      "svg",
      !!e.createElementNS &&
  ...
  Modernizr.addTest("audio", function () {
    ...
    Modernizr.addTest("preserve3d", function () {
      var e,
        ...
        i = A.CSS,
        n = !1;
      return i && i.supports && i.supports("(transform-style: preserve-3d)")
        ? !0
        : ((e = r("a")),
          (t = r("a")),
          (e.style.cssText =
    ...
    Modernizr.addTest(
      "placeholder",
      "placeholder" in r("input") && "placeholder" in r("textarea")
    ),
  ...
  var p = (function () {
    function A(A, e) {
      var n;
      return A
        ? ((e && "string" != typeof e) || (e = r(e || "div")),
          (A = "on" + A),
          (n = A in e),
          !n &&
            i &&
            (e.setAttribute || (e = r("div")),
            e.setAttribute(A, ""),
    ...
    for (var i, n, a, r = A.length, o = "1)", w = 0; r > w; w++)
      Q.setAttribute("type", (i = A[w])),
        ...
        a &&
          ...
          /^range$/.test(i) && Q.style.WebkitAppearance !== t
            ? (g.appendChild(Q),
              (n = e.defaultView),
              (a =
                n.getComputedStyle &&
                "textfield" !== n.getComputedStyle(Q, null).WebkitAppearance &&
                0 !== Q.offsetHeight),
              g.removeChild(Q))
            : /^(search|tel)$/.test(i) ||
              (a = /^(url|email)$/.test(i)
                ? Q.checkValidity && Q.checkValidity() === !1
                : Q.value != o)),
        (h[A[w]] = !!a);
    return h;
  })(m)),
  ...
  (P._prefixes = C),
    ...
    Modernizr.addTest("csspositionsticky", function () {
      var A = "position:",
        ...
        i = t.style;
      return (
        (i.cssText = A + C.join(e + ";" + A).slice(0, -A.length)),
  ...
  R
    ...
    : V('@font-face {font-family:"font";src:url("https://")}', function (A, t) {
    ...
    V(
      "#modernizr{overflow: scroll; width: 40px; height: 40px; }#" +
        C.join("scrollbar{width:10px;} #modernizr::")
          .split("#")
          .slice(1)
          .join("#") +
      ...
      function (e) {
        ...
        (t.innerHTML = "This is a text written in Arial"),
          Modernizr.addTest(
            "subpixelfont",
            A.getComputedStyle
              ? "44px" !== A.getComputedStyle(t, null).getPropertyValue("width")
              : !1
          );
      },
      1,
    ...
    Modernizr.addTest("localizednumber", function () {
      ...
      return (
        (A =
          "number" === a.type && 1.1 === a.valueAsNumber && a.checkValidity()),
        n.removeChild(t),
  ...
  (P.mq = M),
    ...
    Modernizr.addTest(
      "pointermq",
      M("(pointer:coarse),(pointer:fine),(pointer:none)")
    );
          ...
          $respTabs
            ...
            .each(function () {
              ...
              $tabContent
                ...
                .css({ "border-color": options.active_border_color });
              tabcount++;
            });
          count++;
        });
...
!(function (t) {
  ...
  t.fn.countdown = function (e, n) {
    ...
    function f() {
      ...
      var s = e - f;
      if (
        ((s -= 60 * (d = Math.floor(s / 86400)) * 60 * 24),
        (s -= 60 * (o = Math.floor(s / 3600)) * 60),
        (s -= 60 * (l = Math.floor(s / 60))),
        1 == d
          ? i.find(".timeRefDays").text("day")
          : i.find(".timeRefDays").text("days"),
        1 == o
          ? i.find(".timeRefHours").text("hour")
          : i.find(".timeRefHours").text("hours"),
        1 == l
          ? i.find(".timeRefMinutes").text("minute")
          : i.find(".timeRefMinutes").text("minutes"),
        1 == s
          ? i.find(".timeRefSeconds").text("second")
          : i.find(".timeRefSeconds").text("seconds"),
        "on" == a.format)
      ) {
...
!(function (a) {
  ...
  var L,
    M = function (c) {
      ...
      var title = document.getElementById(this.id)
      console.log(title)
      if (d) {
  ...
  a.magnificPopup.registerModule("image", {
    options: {
      markup:
        '<div class="mfp-figure"><div class="mfp-close"></div><figure><div class="mfp-img"></div><figcaption><p> </p><div class="mfp-bottom-bar"><div class="mfp-title"></div><div class="mfp-counter"></div></div></figcaption></figure></div>',
...
function initMap() {
  ...
  new google.maps.Marker({ position: t, title: "Hello World!" }).setMap(s),
    s.mapTypes.set("styled_map", e),
