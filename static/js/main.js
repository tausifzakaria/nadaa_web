...
(function ($) {
  ...
  $window.on("scroll", function () {
    ...
    if (scroll <= 50) {
      ...
      logodefault.attr("src", "/media/img/logos/logo.png");
      ...
      logoinner.attr("src", "media/img/logos/logo.png");
      logodefault.attr("src", "media/img/logos/logo.png");
      logowhite.attr("src", "img/logos/logo-white.png");
  ...
  $(document).on("click", ".triger-modal", function () {
    var Id = $(this).data('id');
    $(".modal-header #cta-header").val( Id );
...
//     setTimeout(function(){
//         $('#callbackModal2').modal('show')
//         $('#callbackModalTitle2').html('Request A Site Visit');
//     }, 2000);
//  });

  var intervalID = setInterval(function(){
    if (!$('.modalclass').hasClass('show')) {
    $('#callbackModal2').modal('show')
    $('#callbackModalTitle2').html('Request A Site Visit');
    }
  }, 35000); // Will alert every second.
